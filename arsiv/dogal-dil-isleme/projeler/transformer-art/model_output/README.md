...
> **Not:** `pytorch_model.bin` ağırlık dosyası repoya dahil edilmemiştir (boyut nedeniyle).
> Ağırlıkları üretmek için üst dizindeki `train.py` dosyasını çalıştırın; eğitim sonunda
> bu klasöre `pytorch_model.bin` olarak kaydedilir.
